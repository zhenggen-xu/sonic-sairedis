 ...
 *    error code is returned.
 */
sai_status_t redis_create_stp_port(
 ...
 *    error code is returned.
 */
sai_status_t redis_remove_stp_port(
 ...
 *    error code is returned.
 */
sai_status_t redis_set_stp_port_attribute(
        _In_ sai_object_id_t stp_port_id,
        _In_ const sai_attribute_t *attr)
{
    std::lock_guard<std::mutex> lock(g_apimutex);
 ...
 *    error code is returned.
 */
sai_status_t redis_get_stp_port_attribute(
        _In_ sai_object_id_t stp_port_id,
        _In_ uint32_t attr_count,
        _Inout_ sai_attribute_t *attr_list)
{
...
const sai_stp_api_t redis_stp_api = {
    ...
    redis_create_stp_port,
    redis_remove_stp_port,
    redis_set_stp_port_attribute,
    redis_get_stp_port_attribute,
