 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_create_acl_table_group(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_remove_acl_table_group(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_set_acl_table_group_attribute(
        _In_ sai_object_id_t acl_table_group_id,
        _In_ const sai_attribute_t *attr)
{
    std::lock_guard<std::recursive_mutex> lock(g_recursive_mutex);
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_get_acl_table_group_attribute(
        _In_ sai_object_id_t acl_table_group_id,
        _In_ uint32_t attr_count,
        _Out_ sai_attribute_t *attr_list)
{
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_create_acl_table_group_member(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_remove_acl_table_group_member(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_set_acl_table_group_member_attribute(
        _In_ sai_object_id_t acl_table_group_member_id,
        _In_ const sai_attribute_t *attr)
{
    std::lock_guard<std::recursive_mutex> lock(g_recursive_mutex);
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_get_acl_table_group_member_attribute(
        _In_ sai_object_id_t acl_table_group_member_id,
        _In_ uint32_t attr_count,
        _Out_ sai_attribute_t *attr_list)
{
...
const sai_acl_api_t vs_acl_api = {
    ...
    vs_create_acl_table_group,
    vs_remove_acl_table_group,
    vs_set_acl_table_group_attribute,
    vs_get_acl_table_group_attribute,
    vs_create_acl_table_group_member,
    vs_remove_acl_table_group_member,
    vs_set_acl_table_group_member_attribute,
    vs_get_acl_table_group_member_attribute,
};
