 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t  vs_set_hostif_trap_group_attribute(
        _In_ sai_object_id_t hostif_trap_group_id,
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_get_hostif_trap_group_attribute(
        _In_ sai_object_id_t hostif_trap_group_id,
        _In_ uint32_t attr_count,
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t  vs_create_hostif_trap(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t  vs_remove_hostif_trap(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_set_hostif_trap_attribute(
        _In_ sai_object_id_t hostif_trap_id,
        _In_ const sai_attribute_t *attr)
{
    std::lock_guard<std::recursive_mutex> lock(g_recursive_mutex);
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_get_hostif_trap_attribute(
        _In_ sai_object_id_t hostif_trap_id,
        _In_ uint32_t attr_count,
        _Inout_ sai_attribute_t *attr_list)
{
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t  vs_create_hostif_user_defined_trap(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t  vs_remove_hostif_user_defined_trap(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_set_hostif_user_defined_trap_attribute(
        _In_ sai_object_id_t hostif_user_defined_trap_id,
        _In_ const sai_attribute_t *attr)
{
    std::lock_guard<std::recursive_mutex> lock(g_recursive_mutex);
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_get_hostif_user_defined_trap_attribute(
        _In_ sai_object_id_t hostif_user_defined_trap_id,
        _In_ uint32_t attr_count,
        _Inout_ sai_attribute_t *attr_list)
{
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_create_hostif_table_entry(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_remove_hostif_table_entry(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_set_hostif_table_entry_attribute(
        _In_ sai_object_id_t hif_table_entry,
        _In_ const sai_attribute_t *attr)
{
    std::lock_guard<std::recursive_mutex> lock(g_recursive_mutex);
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_get_hostif_table_entry_attribute(
        _In_ sai_object_id_t hif_table_entry,
        _In_ uint32_t attr_count,
        _Inout_ sai_attribute_t *attr_list)
{
...
const sai_hostif_api_t vs_hostif_api = {
    ...
    vs_create_hostif_table_entry,
    vs_remove_hostif_table_entry,
    vs_set_hostif_table_entry_attribute,
    vs_get_hostif_table_entry_attribute,
    vs_create_hostif_trap_group,
    vs_remove_hostif_trap_group,
    vs_set_hostif_trap_group_attribute,
    vs_get_hostif_trap_group_attribute,
    vs_create_hostif_trap,
    vs_remove_hostif_trap,
    vs_set_hostif_trap_attribute,
    vs_get_hostif_trap_attribute,
    vs_create_hostif_user_defined_trap,
    vs_remove_hostif_user_defined_trap,
    vs_set_hostif_user_defined_trap_attribute,
    vs_get_hostif_user_defined_trap_attribute,
