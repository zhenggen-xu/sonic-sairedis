 ...
 */
sai_status_t vs_create_next_hop_group_member(
 ...
 * @return SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_remove_next_hop_group_member(
 ...
 * @return #SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_set_next_hop_group_member_attribute(
        _In_ sai_object_id_t next_hop_group_member_id,
        _In_ const sai_attribute_t *attr)
{
    std::lock_guard<std::recursive_mutex> lock(g_recursive_mutex);
 ...
 * @return SAI_STATUS_SUCCESS on success Failure status code on error
 */
sai_status_t vs_get_next_hop_group_member_attribute(
        _In_ sai_object_id_t next_hop_group_member_id,
        _In_ uint32_t attr_count,
        _Inout_ sai_attribute_t *attr_list)
{
...
const sai_next_hop_group_api_t vs_next_hop_group_api = {
    ...
    vs_create_next_hop_group_member,
    vs_remove_next_hop_group_member,
    vs_set_next_hop_group_member_attribute,
    vs_get_next_hop_group_member_attribute,
